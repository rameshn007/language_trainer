...
void main() {
  ...
  group('generateVocabularyQuiz — Word/Phrase Split', () {
    test('generates vocabulary match questions with mixed word/phrases', () {
      final itemsWithPhrases = [
        ...
        LanguageItem(
          id: '13',
          portuguese: 'Eu gosto de',
          english: 'I like to',
          wordType: 'phrase',
        ),
        LanguageItem(
          id: '14',
          portuguese: 'Onde fica o',
          english: 'Where is the',
          wordType: 'phrase',
        ),
        LanguageItem(
          id: '15',
          portuguese: 'Eu quero um',
          english: 'I want a',
          wordType: 'phrase',
        ),
      ];
    ...
    test('generates 4 unique options with enough items', () {
      final items = [
        ...
        LanguageItem(
          ...
          portuguese: 'cachorro',
          english: 'Dog',
          exampleSentencePt: 'O cachorro corre',
          exampleSentenceEn: 'The dog runs',
        ),
        LanguageItem(
          id: '3',
          portuguese: 'pássaro',
          english: 'Bird',
          exampleSentencePt: 'O pássaro voa',
          exampleSentenceEn: 'The bird flies',
        ),
        LanguageItem(
          id: '4',
          portuguese: 'peixe',
          english: 'Fish',
          exampleSentencePt: 'O peixe nada',
          exampleSentenceEn: 'The fish swims',
        ),
      ];
      final result = engine.generateClozeQuestionsFromExamples(items);
      for (final q in result) {
  ...
  group('generateVerbConjugationQuestions — Basic', () {
    ...
    test('returns correct count when verbs exceed count', () {
      final result = engine.generateVerbConjugationQuestions(
        verbs: sampleVerbs,
        count: 2,
      );
    ...
    test('question text mentions the infinitive', () {
      ...
      for (final q in result) {
        expect(
          q.questionText.toLowerCase().contains('falar') ||
              q.questionText.toLowerCase().contains('comer') ||
              q.questionText.toLowerCase().contains('viver'),
          isTrue,
        );
      }
    });
